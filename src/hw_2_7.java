...
public class hw_2_7 {
    public static void main(String[] args) {
        ...
        if(scan.hasNextInt()) {
            ...
            switch (citiesCode) {
                case 905:
                    System.out.println(citiesCodes.get(905) + ": стоимость разговора " + citiesPrice.get(905) * 10);
                    break;

                case 194:
                    System.out.println(citiesCodes.get(194) + ": стоимость разговора " + citiesPrice.get(194) * 10);
                    break;

                case 491:
                    System.out.println(citiesCodes.get(491) + ": стоимость разговора " + citiesPrice.get(491) * 10);
                    break;

                case 800:
                    System.out.println(citiesCodes.get(800) + ": стоимость разговора " + citiesPrice.get(800) * 10);
                    break;
